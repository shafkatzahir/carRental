...
<body>
  ...
  <div class="py-5">
    <h2 class="text-center">WELCOME TO THE ADMIN PORTAL</h2>
  </div>
</p>
    <a href="show_carlist.php" class="btn btn-success">View Car List</a>
    <a href="show_bookinglist.php" class="btn btn-success">View Booking </a>
    </div>
  </div>
